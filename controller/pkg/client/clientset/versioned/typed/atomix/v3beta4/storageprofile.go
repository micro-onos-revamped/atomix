...
type StorageProfileInterface interface {
	Create(ctx context.Context, storageProfile *v3beta4.StorageProfile, opts v1.CreateOptions) (*v3beta4.StorageProfile, error)
	Update(ctx context.Context, storageProfile *v3beta4.StorageProfile, opts v1.UpdateOptions) (*v3beta4.StorageProfile, error)
	UpdateStatus(ctx context.Context, storageProfile *v3beta4.StorageProfile, opts v1.UpdateOptions) (*v3beta4.StorageProfile, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v3beta4.StorageProfile, error)
	List(ctx context.Context, opts v1.ListOptions) (*v3beta4.StorageProfileList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v3beta4.StorageProfile, err error)
...
func newStorageProfiles(c *AtomixV3beta4Client, namespace string) *storageProfiles {
...
func (c *storageProfiles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v3beta4.StorageProfile, err error) {
	result = &v3beta4.StorageProfile{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *storageProfiles) List(ctx context.Context, opts v1.ListOptions) (result *v3beta4.StorageProfileList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v3beta4.StorageProfileList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("storageprofiles").
...
func (c *storageProfiles) Create(ctx context.Context, storageProfile *v3beta4.StorageProfile, opts v1.CreateOptions) (result *v3beta4.StorageProfile, err error) {
	result = &v3beta4.StorageProfile{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("storageprofiles").
...
func (c *storageProfiles) Update(ctx context.Context, storageProfile *v3beta4.StorageProfile, opts v1.UpdateOptions) (result *v3beta4.StorageProfile, err error) {
	result = &v3beta4.StorageProfile{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storageprofiles").
...
func (c *storageProfiles) UpdateStatus(ctx context.Context, storageProfile *v3beta4.StorageProfile, opts v1.UpdateOptions) (result *v3beta4.StorageProfile, err error) {
	result = &v3beta4.StorageProfile{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storageprofiles").
...
func (c *storageProfiles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v3beta4.StorageProfile, err error) {
	result = &v3beta4.StorageProfile{}
