module github.com/micro-onos-revamped/atomix/drivers/shared-memory/tests

go 1.19

require (
	github.com/micro-onos-revamped/atomix/stores/shared-memory v0.7.1-0.20230314010507-dd4da27ce84f
