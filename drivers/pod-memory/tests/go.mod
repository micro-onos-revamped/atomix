module github.com/micro-onos-revamped/atomix/drivers/pod-memory/tests

go 1.19

require (
	github.com/micro-onos-revamped/atomix/stores/pod-memory v0.4.3-0.20230314010507-dd4da27ce84f
