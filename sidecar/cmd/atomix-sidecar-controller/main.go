...
import (
	...
	"github.com/micro-onos-revamped/atomix/controller/pkg/apis"
	...
	"github.com/micro-onos-revamped/atomix/sidecar/pkg/webhook"
...
func getCommand() *cobra.Command {
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			if err := webhook.AddWebhook(mgr); err != nil {
				log.Error(err)
				os.Exit(1)
			}
