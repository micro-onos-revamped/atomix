...
type LeaderElectionSnapshot struct {
	Term       github_com_atomix_atomix_protocols_rsm_api_v1.Index `protobuf:"varint,1,opt,name=term,proto3,casttype=github.com/micro-onos-revamped/atomix/protocols/rsm/api/v1.Index" json:"term,omitempty"`
...
type LeaderElectionCandidate struct {
	...
	SessionID github_com_atomix_atomix_protocols_rsm_api_v1.SessionID `protobuf:"varint,2,opt,name=session_id,json=sessionId,proto3,casttype=github.com/micro-onos-revamped/atomix/protocols/rsm/api/v1.SessionID" json:"session_id,omitempty"`
}
...
type Term struct {
	...
	Index      github_com_atomix_atomix_protocols_rsm_api_v1.Index `protobuf:"varint,3,opt,name=index,proto3,casttype=github.com/micro-onos-revamped/atomix/protocols/rsm/api/v1.Index" json:"index,omitempty"`
}
