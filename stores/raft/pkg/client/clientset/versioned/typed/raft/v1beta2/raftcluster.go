...
type RaftClusterInterface interface {
	Create(ctx context.Context, raftCluster *v1beta2.RaftCluster, opts v1.CreateOptions) (*v1beta2.RaftCluster, error)
	Update(ctx context.Context, raftCluster *v1beta2.RaftCluster, opts v1.UpdateOptions) (*v1beta2.RaftCluster, error)
	UpdateStatus(ctx context.Context, raftCluster *v1beta2.RaftCluster, opts v1.UpdateOptions) (*v1beta2.RaftCluster, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta2.RaftCluster, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta2.RaftClusterList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.RaftCluster, err error)
...
func newRaftClusters(c *RaftV1beta2Client, namespace string) *raftClusters {
	return &raftClusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *raftClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta2.RaftCluster, err error) {
	result = &v1beta2.RaftCluster{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *raftClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1beta2.RaftClusterList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta2.RaftClusterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("raftclusters").
...
func (c *raftClusters) Create(ctx context.Context, raftCluster *v1beta2.RaftCluster, opts v1.CreateOptions) (result *v1beta2.RaftCluster, err error) {
	result = &v1beta2.RaftCluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("raftclusters").
...
func (c *raftClusters) Update(ctx context.Context, raftCluster *v1beta2.RaftCluster, opts v1.UpdateOptions) (result *v1beta2.RaftCluster, err error) {
	result = &v1beta2.RaftCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("raftclusters").
...
func (c *raftClusters) UpdateStatus(ctx context.Context, raftCluster *v1beta2.RaftCluster, opts v1.UpdateOptions) (result *v1beta2.RaftCluster, err error) {
	result = &v1beta2.RaftCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("raftclusters").
...
func (c *raftClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.RaftCluster, err error) {
	result = &v1beta2.RaftCluster{}
