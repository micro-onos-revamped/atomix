...
type RaftPartitionInterface interface {
	Create(ctx context.Context, raftPartition *v1beta3.RaftPartition, opts v1.CreateOptions) (*v1beta3.RaftPartition, error)
	Update(ctx context.Context, raftPartition *v1beta3.RaftPartition, opts v1.UpdateOptions) (*v1beta3.RaftPartition, error)
	UpdateStatus(ctx context.Context, raftPartition *v1beta3.RaftPartition, opts v1.UpdateOptions) (*v1beta3.RaftPartition, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta3.RaftPartition, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta3.RaftPartitionList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta3.RaftPartition, err error)
...
func newRaftPartitions(c *RaftV1beta3Client, namespace string) *raftPartitions {
...
func (c *raftPartitions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta3.RaftPartition, err error) {
	result = &v1beta3.RaftPartition{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *raftPartitions) List(ctx context.Context, opts v1.ListOptions) (result *v1beta3.RaftPartitionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta3.RaftPartitionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("raftpartitions").
...
func (c *raftPartitions) Create(ctx context.Context, raftPartition *v1beta3.RaftPartition, opts v1.CreateOptions) (result *v1beta3.RaftPartition, err error) {
	result = &v1beta3.RaftPartition{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("raftpartitions").
...
func (c *raftPartitions) Update(ctx context.Context, raftPartition *v1beta3.RaftPartition, opts v1.UpdateOptions) (result *v1beta3.RaftPartition, err error) {
	result = &v1beta3.RaftPartition{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("raftpartitions").
...
func (c *raftPartitions) UpdateStatus(ctx context.Context, raftPartition *v1beta3.RaftPartition, opts v1.UpdateOptions) (result *v1beta3.RaftPartition, err error) {
	result = &v1beta3.RaftPartition{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("raftpartitions").
...
func (c *raftPartitions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta3.RaftPartition, err error) {
	result = &v1beta3.RaftPartition{}
