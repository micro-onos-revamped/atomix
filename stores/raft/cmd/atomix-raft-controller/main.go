...
import (
	...
	atomixapis "github.com/micro-onos-revamped/atomix/controller/pkg/apis"
	"github.com/micro-onos-revamped/atomix/controller/pkg/controller/util/k8s"
	...
	raftapis "github.com/micro-onos-revamped/atomix/stores/raft/pkg/apis"
	apisv1beta2 "github.com/micro-onos-revamped/atomix/stores/raft/pkg/apis/raft/v1beta2"
	apisv1beta3 "github.com/micro-onos-revamped/atomix/stores/raft/pkg/apis/raft/v1beta3"
	controllerv1beta3 "github.com/micro-onos-revamped/atomix/stores/raft/pkg/controller/raft/v1beta3"
...
func getCommand() *cobra.Command {
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			if err := atomixapis.AddToScheme(mgr.GetScheme()); err != nil {
				log.Error(err)
				os.Exit(1)
			}
			if err := raftapis.AddToScheme(mgr.GetScheme()); err != nil {
				log.Error(err)
				os.Exit(1)
			}
